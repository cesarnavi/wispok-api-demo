 ...
 *            minimum: 1
*/
usersRouter.get("/", middlewares_1.withJWT, controllers_1.getUsers);
/**
 * @swagger
 *  /users:
 *    post:
 ...
 *                  $ref: "#/components/schemas/User"
 */
usersRouter.post("/", controllers_1.createUser);
/**
 * @swagger
 * /users/{userId}:
 *    get:
 ...
 *
*/
usersRouter.get("/:userId", middlewares_1.withJWT, controllers_1.getUserById);
/**
 * @swagger
 * /users/{userId}:
 *    put:
 ...
 *
*/
usersRouter.put("/:userId", middlewares_1.withJWT, controllers_1.updateUser);
/**
 * @swagger
 * /users/{userId}:
 *    delete:
 ...
 *
*/
usersRouter.delete("/:userId", middlewares_1.withJWT, controllers_1.deleteUserById);
